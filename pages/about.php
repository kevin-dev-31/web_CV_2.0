...
<body id="about">
	<main>
		...
		<div class="container mt-5 mb-5">
			<h2>Qui suis-je?</h2>
			<p>
				Moi c’est Kévin, j’ai 31 ans, je suis passionnée par les jeux vidéo, mes parents on acheter une séga master système quand j’avais 2 ans, depuis ce jours je n’ai jamais arrêté 😁 je suis mordu de rétro gaming, ce qui fait que je collectionne les consoles et les jeux (surtout séga et nintendo).
			</p>
			<p>
		...
		<div>
			<img src="../img/test.png" class="img-fluid" alt="photo de sport me représentant">
		</div>
